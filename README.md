...
-wind-field decay <Br>
-Parametric pricing structure <Br>
-EP curve <Br>
...
**Generated Stochastic_YLT_49999** a 49,999-row Year Loss Table, the standard cat-model output format. Each row is one simulated year: number of storms, the worst storm's peak intensity, its distance of closest approach to a single reference site, the resulting site-level wind speed, category, and payout.<br>
